...
function InvoicePaymentView({ 
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-[#E86825]/5 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin mx-auto mb-4 text-[#E86825]" />
  ...
  if (!invoiceData.allowOnlinePayment) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-[#E86825]/5 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-md shadow-lg border border-slate-200 overflow-hidden">
          ...
          <div className="p-6 text-center border-b border-slate-100">
            ...
            <p className="text-2xl font-bold text-[#E86825] mt-2">${parseFloat(invoiceData.total).toFixed(2)} AUD</p>
          </div>
          ...
          {hasBankDetails ? (
            ...
            <div className="p-6">
              <div className="bg-[#E86825]/5 rounded-xl p-4 border border-[#E86825]/20" data-testid="payment-instructions">
                <div className="flex items-center gap-2 mb-2">
                  <FileText className="h-4 w-4 text-[#E86825]" />
                  <h3 className="font-semibold text-[#B5491A] text-sm">Payment Instructions</h3>
                </div>
                <p className="text-sm text-[#C45A20] whitespace-pre-wrap">
                  {invoiceData.business.paymentInstructions}
                </p>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-[#E86825]/5 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-block mb-4">
            {invoiceData.business.logo ? (
              ...
              <div className="w-16 h-16 bg-[#E86825]/10 rounded-full flex items-center justify-center mx-auto">
                <FileText className="h-8 w-8 text-[#E86825]" />
              </div>
            )}
          </div>
        ...
        <div className="grid gap-6">
          ...
          {clientSecret && stripePromise && (
            <div className="bg-[#E86825]/5 rounded-md shadow-xl border-2 border-[#E86825]/20 overflow-hidden ring-2 ring-[#E86825]/10">
              <div className="px-6 py-5 border-b border-[#E86825]/15 bg-white/50 backdrop-blur-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <CreditCard className="h-5 w-5 text-[#E86825]" />
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-black text-[#E86825]">${total.toFixed(2)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 py-4 bg-slate-50/80 border-t border-slate-100 backdrop-blur-sm">
                <div className="flex items-center justify-center gap-8 text-xs font-medium text-slate-500">
                  ...
                  <div className="flex items-center gap-1.5">
                    <Lock className="h-4 w-4 text-[#E86825]" />
          ...
          <div className="bg-white rounded-md shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              ...
              {!(invoiceData.business.bankBsb || invoiceData.business.bankAccountNumber || invoiceData.business.bankAccountName) && invoiceData.business.paymentInstructions && (
                <div className="bg-[#E86825]/5 rounded-xl p-4 border border-[#E86825]/15" data-testid="payment-instructions">
                  <div className="flex items-center gap-2 mb-2">
                    <FileText className="h-4 w-4 text-[#E86825]" />
                    <h3 className="font-semibold text-[#B5491A] text-sm">Payment Instructions</h3>
                  </div>
                  <p className="text-sm text-[#C45A20] whitespace-pre-wrap italic">
                    {invoiceData.business.paymentInstructions}
                  </p>
                </div>
              )}
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          {requestData.businessLogo ? (
            ...
            <div className="w-16 h-16 bg-[#E86825]/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <CreditCard className="h-8 w-8 text-[#E86825]" />
            </div>
          )}
        ...
        <div className="grid gap-6">
          {/* Amount Card */}
          <div className="bg-white rounded-md shadow-lg border border-slate-200 overflow-hidden">
            <div className="bg-gradient-to-r from-[#E86825] to-[#C45A20] text-white py-6 px-6 text-center">
          ...
          {requestData.isDemoMode && (
            <div className="bg-white rounded-md shadow-lg border border-orange-200 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <Button
                  className="w-full bg-[#E86825] text-white"
                  size="lg"
