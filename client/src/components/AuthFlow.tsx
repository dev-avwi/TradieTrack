              ...
              <CardContent className="p-6 lg:p-8">
                ...
                {appleAuthEnabled && (
                  <Button 
                    ...
                    variant="outline"
                    className="w-full h-12 text-base font-medium border-2 bg-black text-white border-black hover:bg-gray-900 dark:bg-black dark:text-white dark:border-gray-700 dark:hover:bg-gray-900 transition-all"
