...
const createQuoteEmail = (quote: any, client: any, business: any, acceptanceUrl?: string | null) => {
  ...
  const brandColor = business.brandColor || '#0A6A73';
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          ${business.gstEnabled ? `
            ...
            <div style="display: flex; justify-content: space-between; border-top: 2px solid #0A6A73; padding-top: 10px; font-size: 20px; font-weight: bold; color: #0A6A73;">
              <span>Total Amount:</span>
              <span>$${totalAmount.toFixed(2)}</span>
            </div>
          ` : `
            <h3 style="margin: 0 0 10px 0; color: #333;">Total Amount</h3>
            <p style="font-size: 24px; font-weight: bold; color: #0A6A73; margin: 0;">$${totalAmount.toFixed(2)}</p>
          `}
        </div>
  ...
  return {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        ${paymentUrl ? `
        <div style="text-align: center; margin: 30px 0; padding: 24px; background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 12px; border: 1px solid #E8862E;">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          ${business.gstEnabled ? `
            ...
            <div style="display: flex; justify-content: space-between; border-top: 2px solid #ddd; padding-top: 10px; font-size: 20px; font-weight: bold; color: #0A6A73;">
              <span>Total Amount:</span>
              <span>$${totalAmount.toFixed(2)}</span>
            </div>
          ` : `
            <div style="display: flex; justify-content: space-between; font-size: 20px; font-weight: bold; color: #0A6A73;">
              <span>Total Amount:</span>
              <span>$${totalAmount.toFixed(2)}</span>
            </div>
          `}
...
const createReceiptEmail = (invoice: any, client: any, business: any) => {
  ...
  return {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #0A6A73; color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
          <div style="background: white; display: inline-block; padding: 12px 20px; border-radius: 8px; margin-bottom: 12px;">
            <img src="${logoUrl}" alt="${business.businessName || 'JobRunner'}" style="max-height: 48px; max-width: 160px; display: block;" />
          </div>
        ...
        <div style="margin-bottom: 20px;">
          <h2 style="color: #333; border-bottom: 2px solid #0A6A73; padding-bottom: 10px;">Payment Details</h2>
          ...
          <p><strong>Status:</strong> <span style="background: #0A6A73; color: white; padding: 2px 8px; border-radius: 4px;">PAID</span></p>
        </div>
  ...
  try {
    const pdfHtml = generatePaymentReceiptPDF({
      ...
      business: {
        ...
        brandColor: businessWithLogo?.brandColor || '#0A6A73',
      },
      invoice: invoice ? {
        id: invoice.id,
  ...
  return {
    ...
    html: `
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.7; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f9fafb;">
        <div style="background: linear-gradient(135deg, #0A6A73 0%, #064E56 100%); padding: 40px 32px; border-radius: 16px 16px 0 0; text-align: center;">
        ...
        <div style="background: white; padding: 32px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="${verificationUrl}" style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; padding: 14px 32px; text-decoration: none; border-radius: 10px; display: inline-block; font-weight: 600; font-size: 15px; box-shadow: 0 4px 14px rgba(10, 106, 115, 0.35);">Verify Email Address</a>
          </div>
...
export const sendLoginCodeEmail = async (email: string, code: string) => {
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          <h1 style="color: #0A6A73; margin: 0;">JobRunner</h1>
        </div>
        ...
        <div style="margin-bottom: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; text-align: center; margin: 20px 0;">
            <p style="font-size: 32px; font-weight: bold; letter-spacing: 8px; color: #0A6A73; margin: 0;">${code}</p>
          </div>
...
export const sendPasswordResetEmail = async (user: any, resetToken: string) => {
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); padding: 30px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <div style="background: white; padding: 15px; border-radius: 6px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #0A6A73;">Your ${plan} Plan is Active</h3>
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${paymentUrl}" style="background-color: #0A6A73; color: white; padding: 16px 40px; text-decoration: none; border-radius: 8px; display: inline-block; font-size: 18px; font-weight: bold;">
            Pay Now Securely
          </a>
          <p style="margin-top: 12px; color: #666; font-size: 14px;">Click the button above to pay with your card</p>
        </div>
        
        <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #E8862E;">
...
export async function sendWelcomeEmail(
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.7; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f9fafb;">
        <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); padding: 44px 32px; border-radius: 16px 16px 0 0; text-align: center;">
          <img src="${logoUrl}" alt="JobRunner" style="max-width: 140px; height: auto; margin-bottom: 20px;" />
          <h1 style="color: white; margin: 0; font-size: 26px; font-weight: 600; letter-spacing: -0.5px;">Welcome to JobRunner!</h1>
        ...
        <div style="background: white; padding: 32px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
          ...
          <div style="background: #eff6ff; padding: 28px; border-radius: 12px; margin: 28px 0;">
            <h3 style="margin: 0 0 24px 0; color: #0A6A73; text-align: center; font-size: 17px; font-weight: 600; letter-spacing: -0.3px;">Quick Start Guide</h3>
            
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
              <tr>
                <td style="padding-bottom: 18px; vertical-align: top; width: 44px;">
                  <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; width: 26px; height: 26px; border-radius: 50%; text-align: center; line-height: 26px; font-weight: 600; font-size: 13px; display: inline-block;">1</div>
                </td>
                <td style="padding-bottom: 18px; vertical-align: top;">
                  <strong style="color: #0A6A73; font-size: 14px; font-weight: 600;">Set up your business profile</strong>
              ...
              <tr>
                <td style="padding-bottom: 18px; vertical-align: top; width: 44px;">
                  <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; width: 26px; height: 26px; border-radius: 50%; text-align: center; line-height: 26px; font-weight: 600; font-size: 13px; display: inline-block;">2</div>
                </td>
                <td style="padding-bottom: 18px; vertical-align: top;">
                  <strong style="color: #0A6A73; font-size: 14px; font-weight: 600;">Add your first client</strong>
              ...
              <tr>
                <td style="padding-bottom: 18px; vertical-align: top; width: 44px;">
                  <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; width: 26px; height: 26px; border-radius: 50%; text-align: center; line-height: 26px; font-weight: 600; font-size: 13px; display: inline-block;">3</div>
                </td>
                <td style="padding-bottom: 18px; vertical-align: top;">
                  <strong style="color: #0A6A73; font-size: 14px; font-weight: 600;">Create a quote</strong>
              ...
              <tr>
                <td style="padding-bottom: 18px; vertical-align: top; width: 44px;">
                  <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; width: 26px; height: 26px; border-radius: 50%; text-align: center; line-height: 26px; font-weight: 600; font-size: 13px; display: inline-block;">4</div>
                </td>
                <td style="padding-bottom: 18px; vertical-align: top;">
                  <strong style="color: #0A6A73; font-size: 14px; font-weight: 600;">Convert quote to job</strong>
          ...
          <div style="background: #fef3c7; padding: 16px 18px; border-radius: 10px; margin: 24px 0; border-left: 4px solid #E8862E;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="${effectiveBaseUrl}" style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); color: white; padding: 14px 36px; text-decoration: none; border-radius: 10px; display: inline-block; font-size: 15px; font-weight: 600; box-shadow: 0 4px 14px rgba(10, 106, 115, 0.35);">
              Get Started Now
            </a>
          </div>
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb;">
        <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); padding: 40px 30px; border-radius: 12px 12px 0 0; text-align: center;">
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 25px 0; border-left: 4px solid #0A6A73;">
            <h3 style="margin: 0 0 15px 0; color: #0A6A73;">What you'll be able to do:</h3>
...
export async function sendJobAssignmentEmail(
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb;">
        <div style="background: linear-gradient(135deg, #E8862E 0%, #C86B1A 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 25px 0; border-left: 4px solid #E8862E;">
            <h3 style="margin: 0 0 15px 0; color: #925714;">${jobTitle}</h3>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${jobUrl}" style="background-color: #E8862E; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block; font-size: 16px; font-weight: bold;">
              View Job Details
            </a>
          </div>
...
export async function sendJobCompletionNotificationEmail(
  ...
  const emailData = {
    ...
    html: `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb;">
        <div style="background: linear-gradient(135deg, #0A6A73 0%, #053D43 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
...
export function createDailySummaryEmail(data: DailySummaryData): { to: string; from: any; subject: string; html: string } {
  const brandColor = data.business.brandColor || '#0A6A73';
  ...
  const paymentsHtml = data.payments.paymentsList.length > 0
    ? data.payments.paymentsList.map(payment => `
      <tr>
        ...
        <td style="padding: 10px 12px; border-bottom: 1px solid #eee; text-align: right; color: #0A6A73; font-weight: 600;">${formatCurrency(payment.amount)}</td>
      </tr>
    `).join('')
    : '';
  ...
  const actionItemsHtml = data.actionItems.length > 0
    ? data.actionItems.map(item => {
        const priorityColor = item.priority === 'high' ? '#dc2626' : item.priority === 'medium' ? '#E8862E' : '#6b7280';
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
          ...
          <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 30px;">
            ...
            <div style="flex: 1; min-width: 140px; background: #eff6ff; padding: 20px; border-radius: 8px; text-align: center;">
              <p style="margin: 0; color: #0A6A73; font-size: 28px; font-weight: 700;">${data.jobs.completed}</p>
              <p style="margin: 4px 0 0 0; color: #0A6A73; font-size: 13px;">Jobs Completed</p>
            </div>
          ...
          <div style="margin-bottom: 30px;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 12px; margin-bottom: 16px;">
              <div style="background: #f8f9fa; padding: 12px 16px; border-radius: 6px;">
                <span style="color: #0A6A73; font-weight: 600;">${data.jobs.completed}</span> Completed
              </div>
              <div style="background: #f8f9fa; padding: 12px 16px; border-radius: 6px;">
                <span style="color: #0A6A73; font-weight: 600;">${data.jobs.inProgress}</span> In Progress
              </div>
              <div style="background: #f8f9fa; padding: 12px 16px; border-radius: 6px;">
          ...
          <div style="margin-bottom: 30px;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 12px;">
              ...
              <div style="background: #f0fdf4; padding: 12px 16px; border-radius: 6px;">
                <span style="color: #0A6A73; font-weight: 600;">${data.quotes.accepted}</span> Accepted (${formatCurrency(data.quotes.acceptedTotal)})
              </div>
              ...
              <div style="background: #fffbeb; padding: 12px 16px; border-radius: 6px;">
                <span style="color: #E8862E; font-weight: 600;">${data.quotes.pending}</span> Pending
              </div>
            </div>
          </div>
          ...
          <div style="margin-bottom: 30px;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 12px;">
              ...
              <div style="background: #f0fdf4; padding: 12px 16px; border-radius: 6px;">
                <span style="color: #0A6A73; font-weight: 600;">${data.invoices.paid}</span> Paid (${formatCurrency(data.invoices.paidTotal)})
              </div>
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
              ...
              <tfoot>
                <tr style="background: #f0fdf4;">
                  ...
                  <td style="padding: 12px; text-align: right; font-weight: 700; color: #0A6A73; font-size: 16px;">${formatCurrency(data.payments.totalAmount)}</td>
                </tr>
              </tfoot>
            </table>
          </div>
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
            <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 16px; text-align: center;">
              <div>
                ...
                <p style="margin: 4px 0 0 0; font-weight: 700; color: #0A6A73; font-size: 18px;">${formatCurrency(data.metrics.totalRevenue)}</p>
              </div>
              <div>
                <p style="margin: 0; color: #666; font-size: 12px;">Outstanding Invoices</p>
                <p style="margin: 4px 0 0 0; font-weight: 700; color: #E8862E; font-size: 18px;">${formatCurrency(data.metrics.outstandingInvoices)}</p>
              </div>
            </div>
          </div>
        </div>
