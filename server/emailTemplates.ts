...
// Brand colors
const BRAND_BLUE = '#E86825';
const SUCCESS_GREEN = '#E86825';
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td style="text-align: center;">
          ...
          ${email ? `<p style="margin: 4px 0 0 0;"><a href="mailto:${email}" style="color: #E86825; text-decoration: none; font-size: 14px;">${email}</a></p>` : ''}
          ${phone ? `<p style="margin: 4px 0 0 0;"><a href="tel:${phone}" style="color: #E86825; text-decoration: none; font-size: 14px;">${phone}</a></p>` : ''}
