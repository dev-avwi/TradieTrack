...
*   **PDF Generation**: Server-side generation of customizable quotes, invoices, and Job Proof Packs via Puppeteer. Proof Packs include section toggles (Timeline, Worker Hours, GPS Verification, Materials, Photos, Invoice Summary) and GPS Worker Presence Verification with geofence alert data.
