...
*   **Mobile Feature Parity**: React Native app is fully parity with web: Saved Filters on Jobs screen, Profitability by Job Type in Reports, Payment Milestones & Retention on Invoice Detail, Schedule Conflict Warnings on Calendar, Trade Calculators (Concrete, Roof Pitch, Tile, Paint, Baluster), and Materials Cost vs Sell Price with margin % on Job Detail.
