...
*   **Enhanced Sidebar Header**: Made sidebar logo/business name clickable to navigate to `/settings` (My Account) page. Improved visual appearance with larger logo (10x10), border, shadow, and "My Account" helper text. Uses `data-testid="button-sidebar-settings"` for testing.
