...
*   **AI Receptionist**: Voice-based assistant (Vapi.ai + ElevenLabs) with automated SMS follow-ups (Auto-Reply), push notifications for tradies, call recording playback, and caller sentiment analysis/scoring.
