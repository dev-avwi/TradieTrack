...
const BRAND_COLORS = [
  '#0F766E', '#1877F2', '#0A66C2', '#2563EB', '#3B82F6',
...
export default function SettingsScreen() {
  ...
  const loadBrandSettings = useCallback(async () => {
    try {
      ...
      if (stored) {
        const settings = JSON.parse(stored);
        setSelectedColor(settings.color || '#0F766E');
