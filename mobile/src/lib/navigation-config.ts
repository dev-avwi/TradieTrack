...
export const mainMenuItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: "activity",
    description: "Live operations center",
    color: "primary",
    bgColor: "primary",
    requiresTeam: false,
    requiresOwnerOrManager: false,
  ...
  },
  {
    ...
    url: "/more/leads",
    icon: "user-plus",
    description: "Track leads and enquiries",
    color: "info",
    bgColor: "info",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    url: "/more/service-reminders",
    icon: "bell",
    description: "Recurring maintenance reminders",
    color: "warning",
    bgColor: "warning",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    icon: "hash",
    description: "Concrete, tile, paint & more",
    color: "success",
    bgColor: "success",
    showInMore: true,
    category: "work",
  ...
  {
    title: "Team Groups",
    url: "/more/team-groups",
    icon: "users",
    description: "Create and manage crew groups",
    color: "primary",
    bgColor: "primary",
    requiresTeam: false,
    hideForStaff: true,
  ...
  },
  {
    ...
    url: "/more/team-dashboard",
    icon: "monitor",
    description: "Team status and activity overview",
    color: "info",
    bgColor: "info",
    requiresTeam: false,
    hideForStaff: true,
  ...
  },
  {
    ...
    url: "/more/rebates",
    icon: "percent",
    description: "Track rebates and incentives",
    color: "success",
    bgColor: "success",
    hideForStaff: true,
    showInMore: true,
...
export const sidebarMainItems: SidebarNavItem[] = [
  ...
  { 
    ...
    title: 'Recurring Jobs', 
    icon: 'repeat', 
    path: '/more/recurring-jobs',
    matchPaths: ['/more/recurring-jobs'],
    section: 'main',
    hideForStaff: true,
    allowedRoles: ['owner', 'solo_owner', 'manager'],
  },
  { 
    ...
    title: 'Service Reminders', 
    icon: 'bell', 
    path: '/more/service-reminders',
    matchPaths: ['/more/service-reminders'],
    section: 'main',
    hideForStaff: true,
    allowedRoles: ['owner', 'solo_owner', 'manager'],
  },
  ...
  { 
    ...
    title: 'Team Groups', 
    icon: 'users', 
    path: '/more/team-groups',
    matchPaths: ['/more/team-groups'],
    section: 'main',
    hideForStaff: true,
    allowedRoles: ['owner', 'solo_owner', 'manager'],
  },
  { 
    ...
    title: 'Team Dashboard', 
    icon: 'monitor', 
    path: '/more/team-dashboard',
    matchPaths: ['/more/team-dashboard'],
    section: 'main',
    hideForStaff: true,
    allowedRoles: ['owner', 'solo_owner', 'manager'],
  },
