...
export const mainMenuItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: "repeat",
    description: "Manage recurring job schedules",
    color: "primary",
    bgColor: "primary",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    icon: "bell",
    description: "Recurring maintenance schedules",
    color: "primary",
    bgColor: "primary",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    url: "/more/rebates",
    icon: "award",
    description: "Manufacturer rebates and credits",
    color: "primary",
    bgColor: "primary",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    url: "/more/inventory",
    icon: "package",
    description: "Stock levels, categories & orders",
    color: "primary",
    bgColor: "primary",
    hideForStaff: true,
    showInMore: true,
  ...
  },
  {
    ...
    icon: "layout",
    description: "Assign jobs and manage scheduling",
    color: "primary",
    bgColor: "primary",
    requiresTeam: false,
    requiresOwnerOrManager: false,
  ...
  },
  {
    ...
    icon: "users",
    description: "Organise crew groups",
    color: "primary",
    bgColor: "primary",
    requiresOwnerOrManager: true,
    hideForStaff: true,
...
export const sidebarMainItems: SidebarNavItem[] = [
  ...
  { 
    ...
    title: 'Dispatch Board', 
    icon: 'layout', 
    path: '/more/dispatch-board',
    matchPaths: ['/more/dispatch-board'],
    section: 'main',
    hideForStaff: true,
    allowedRoles: ['owner', 'solo_owner', 'manager'],
  },
